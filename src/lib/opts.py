...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--test_mot15', default=True, help='test mot15')
    ...
    self.parser.add_argument('--input-video', type=str,
                             default='/home/gl/FairMOT/videos/ARC_track.mp4',
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home/gl/FairMOT/dataset')
  ...
  def parse(self, args=''):
    ...
    if opt.resume and opt.load_model == '':
      ...
      opt.load_model = os.path.join(model_path, 'model_100.pth')
  ...
  def init(self, args=''):
    default_dataset_info = {
      'mot': {'default_resolution': [4096, 4096], 'num_classes': 1,
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'mot', 'nID': 14455},
    }
    class Struct:
